        ...
        with open("PlotData\\" + "cert_result.txt", 'w') as f:
            for key in self.certificate_dict.keys():
                f.write(str(key) + space +
                        ...
                        str(self.certificate_dict[key].get_is_CN_in_SAN()) + space +
                        str(self.certificate_dict[key].get_certificate_key_length()) + space +
                        str(self.certificate_dict[key].get_number_san_domains()) + space +
                        str(self.certificate_dict[key].get_number_of_server_name()) + space +
                        str(self.certificate_dict[key].get_not_valid_certificate_number()) + space +
                        str(self.certificate_dict[key].get_certificate_ratio()) + space +

                        self.certificate_dict[key].get_label_of_connection() +
                        '\n')
        f.close()
